                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 border-right">
                      ...
                      <div
                        class="list d-flex align-items-center border-bottom py-3"
                      >
                        <div class="wrapper w-200">
                          <p class="mb-0">
                            <b>Nombre: </b>{{ driver.nombre }}
                            {{ driver.apellidoPaterno }}
                            {{ driver.apellidoMaterno }}
                          </p>
                          <div
                    ...
                    <div class="col-lg-6 col-md-4">
                      ...
                      <select class="form-control" v-model="selectedvehicle">
                        <option
                          v-for="item in vehicle_revisions"
                          :value="item"
                          :key="item.id"
                        >
                          {{ item.vehicle.placa }}
                      ...
                      <div class="form-group" style="margin-top: 30px">
                        ...
                        <div class="list-wrapper">
                          <ul
                            v-for="item1 in selectedvehicle.requirements"
                            :key="item1.id"
                          >
                            <li style="padding: 0">
                              <div class="form-check">
